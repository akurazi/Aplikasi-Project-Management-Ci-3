...
<body>
    ...
    <?php foreach ($pelaksana as $pe) : ?>
        ...
        $project =  $this->db->get_where('x_pelaksana', 'id_pelaksana = ' . $pe->id_pelaksana);
        foreach ($project->result() as $pro) :          ?>
            <table id="table">
                <thead>
                    <tr>
                        <th colspan="3"><?= $pro->nama_project . " | " . $pro->nama_aplikasi ?></th>
                    </tr>
                    <tr>
                        <th>Modul</th>
                        <th>Sub Modul</th>
                ...
                <tbody>
                    ...
                    $mod = $this->db->get_where('x_aplikasi', ['id_aplikasi  ' => $pro->id_aplikasi, 'id_pelaksana' => $pe->id_pelaksana]);
