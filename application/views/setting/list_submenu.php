                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" id="example1">
                                ...
                                <tbody>
                                    <?php $no = 1;
                                    foreach ($submenu->result() as $p) :
                                    ?>
                                        <tr>
                                            <td><?= $no ?></td>
                                            <?php $menu = $this->db->get_where('menu', 'id_menu =' . $p->is_main)->row_array(); ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('Setting/hapusSubmenu' . $p->id_menu) ?>" class="btn btn-sm btn-danger" onclick="return confirm(' Anda Yakin ingin Menghapus Data ini?')"><i class="fa fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php $no++;
                                    endforeach; ?>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Sub Menu </h5>
            ...
            <form class="form-horizontal">
                <div class="modal-body">
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" id="menuu" name="menuu">
                            <option>Pilih Menu</option>
                            <?php
                            foreach ($menuu->result() as $me) {
                                echo "<option value='" . $me->id_menu . "'>" . $me->nama_menu . "</option>";
                            } ?>
                        </select>
                    </div>
                    <div class="input-group mb-2 mr-sm-2">
...
<div class="modal fade" id="ModalaEdit" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myModalLabel">Edit Sub Menu</h3>
            </div>
            <form class="form-horizontal">
                <div class="modal-body">
                    <div class="input-group mb-2 mr-sm-2">
                        ...
                        <select class="form-control" id="menuu_edit" name="menuu_edit">
                            <option>Pilih Menu</option>
                            <?php
                            foreach ($menuu->result() as $me) {
                                echo "<option value='" . $me->id_menu . "'>" . $me->nama_menu . "</option>";
...
<script>
    ...
    $('#btn_simpan').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url('Setting/tambahSub') ?>",
            dataType: "JSON",
            data: {
                nama: nama,
                link: link,
            ...
            success: function(data) {
                ...
                alert('Sukses Menambahkan Sub Menu');
                location.reload();
            }
        });
        return false;
    ...
    $('.item-edit').on('click', function() {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('Setting/get_submenu') ?>",
            dataType: "JSON",
            data: {
                id: id
            },
            success: function(data) {
                $.each(data, function(nama, jabatan) {
                    ...
                    $('[name="menuu_edit"]').val(data.menuu);
    ...
    $('#btn_update').on('click', function() {
        ...
        var menu = $('#menuu_edit').val()

        $.ajax({
            type: "POST",
            url: "<?php echo base_url('Setting/updateSubmenu') ?>",
            dataType: "JSON",
            data: {
                id: id,
                nama: nama,
